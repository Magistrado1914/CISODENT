...
function credenciales($usuario, $pass)
{
    ...
    if (($usuario != $_SERVER['PHP_AUTH_USER']) OR ($pass != $_SERVER['PHP_AUTH_PW'])) {
        echo "Acceso no autorizado $usuario_recibido";
        die();
    }
}
...
function enviar_texto_Plataforma($texto, $plataforma)
{
    echo '{"fulfillmentText": "' . $texto . '",
    "fulfillmentMessages": [
      {
